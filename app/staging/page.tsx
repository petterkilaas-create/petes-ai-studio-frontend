...
export default function ExpressPage() {
  ...
  const [progressStatus, setProgressStatus] = useState("Klargjør AI-motoren..."); // Styres nå av databasen
  ...
  useEffect(() => {
    ...
    if (isRendering) {
        setProgressPct(0);
        setProgressStatus("Laster opp filer...");
  ...
  // ==========================================
  // DEN NYE SKUDDSIKRE POLLEREN (Kopiert fra Staging)
  // ==========================================
  useEffect(() => {
  ...
  const submitRetouch = async () => { 
      ...
      const aCtx = apiCanvas.getContext('2d'); if (!aCtx) return; aCtx.fillStyle = 'black'; aCtx.fillRect(0, 0, apiCanvas.width, apiCanvas.height); 
